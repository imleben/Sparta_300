...
# 데이터 읽기
file_path <- "/mnt/d/OneDrive/Sparta_300/diversity_20FNS/alpha_meta_combined/alpha_meta_combined.tsv"
...
# 출력 경로
output_dir <- "/mnt/d/OneDrive/Sparta_300/diversity_20FNS/alpha_meta_combined/alpha_kruskal"
